...
export { default as Insert } from './mongodb/methods/insert.method';
export { default as InsertOne } from './mongodb/methods/insert-one.method';
...
export * from './mongodb/operations/delete.types';
export * from './mongodb/operations/update.types';
